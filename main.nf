...
process trim_galore {
    ...
    """
    trim_galore --adapter ${three_prime_adapter} $tg_length $c_r1 $tpc_r1 --max_length ${params.max_length} --gzip $reads --fastqc
    """
}
...
process mirdeep2 {
    ...
    sed -i '/^[^>]/s/[R|Y|W|S|M|K|H|B|V|D|N]/N/g' hairpin_yn.fa
